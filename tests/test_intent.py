...
def test_build_plan_respects_routing_preferences():
    ...
    assert anime_plan.preferred_torrent_sources == ["torznab", "nyaa", "dmhy", "bangumi_moe", "bitsearch", "torrentgalaxy", "tpb", "1337x", "limetorrents", "torlock", "ext_to", "eztv", "yts", "knaben", "solidtorrents", "btdig", "torrentcsv", "glodls", "idope"]
    ...
    assert software_plan.preferred_torrent_sources == ["torznab", "torrentmac", "fitgirl", "torrentgalaxy", "bitsearch", "tpb", "1337x", "limetorrents", "torlock", "ext_to", "nyaa", "knaben", "solidtorrents", "btdig", "torrentcsv", "glodls", "idope"]
